...
$result = mysqli_query($connection, "SELECT * FROM absen_masuk ORDER BY id DESC");
?>
...
<head>
    ...
    <title>Presensi Masuk | Tukuo Dimsum</title><script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
